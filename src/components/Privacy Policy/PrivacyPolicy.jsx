...
const PrivacyPolicy = () => {
    return (
        <div className=" bg-gray-50 p-8 lg:p-16">
            ...
            <p className="text-sm text-gray-500 mb-4 text-center">Last updated: July 07, 2024</p>
            ...
            <ul className="list-disc list-inside mb-4 space-y-2">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Goa Resort Week.</li>
                ...
                <li><strong>Website</strong> refers to Goa Resort Week, accessible from <a href="http://www.goaresortweek.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">http://www.goaresortweek.com</a></li>
            ...
            <p className="mb-4">
                Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Use of Cookies by Free Privacy Policy</a>.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-disc  mb-4 space-y-2">
                ...
                <li><strong>To provide You</strong> with news, special offersand general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.            </li>
      ...
      <h4 className="text-lg font-medium mt-4">Business Transactions</h4>
      <p className="mb-4">
        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
      </p>

      <h4 className="text-lg font-medium mt-4">Law Enforcement</h4>
      <p className="mb-4">
        Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
      </p>

      <h4 className="text-lg font-medium mt-4">Other Legal Requirements</h4>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold mt-8">Children's Privacy</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold mt-8">Links to Other Websites</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-bold mt-8">Changes to this Privacy Policy</h2>
      <p className="mb-4">
      ...
      <ul className="list-disc  mb-4">
        <li>
          <p>
            By visiting this page on our website: <a href="http://www.goaresortweek.com/contact"  target="_blank" className="text-blue-500 hover:underline">http://www.goaresortweek.com/contact</a>
          </p>
        </li>
        <li>
