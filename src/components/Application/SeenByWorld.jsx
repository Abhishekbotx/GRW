...
const GoaResortWeek = ({ onClick }) => (
  <div 
    ...
    onClick={onClick}
  >
    <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl mt-8 text-center leading-tight sm:leading-snug">
    ...
    <Link to="/create-account">
      <button className="bg-black text-white px-6 py-2 rounded mt-4 text-sm md:text-base lg:text-lg lg:px-12 hover:bg-gray-800">
        Join Now
      </button>
    </Link>
  </div>
